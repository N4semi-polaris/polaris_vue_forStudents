  ...
  getters: {
    ...
    actions: {
       async obtainToken() {//jwt(drf)のtokenを取得&googleのトークン切れ確認     
        ...
        await axios.post("//nakano2021seminar.pythonanywhere.com/accounts/api-auth/obtain/", data)
          .then(response => {
      ...
      checkTokenExpiration() {//12_3追記(headers を指定しなければ無事に200が返ってくるようになった)
        ...
        axios.post("//nakano2021seminar.pythonanywhere.com/accounts/api-auth/verify/", data)
